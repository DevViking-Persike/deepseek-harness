...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  DockerComposeRequest: 'docker.md',
  DockerComposeResult: 'docker.md',
  DockerContainer: 'docker.md',
  DockerControlRequest: 'docker.md',
  DockerEngineResult: 'docker.md',
  DockerEngineStatus: 'docker.md',
  DockerImage: 'docker.md',
  DockerListRequest: 'docker.md',
  DockerLogsRequest: 'docker.md',
  DockerLogsResult: 'docker.md',
  DockerProvider: 'docker.md',
  GitBaseComparison: 'git.md',
  GitBaseRequest: 'git.md',
  GitBranch: 'git.md',
  GitCommit: 'git.md',
  GitCommitRequest: 'git.md',
  GitDiff: 'git.md',
  GitDiffRequest: 'git.md',
  GitDiscardRequest: 'git.md',
  GitDiscardResult: 'git.md',
  GitDiscoverRequest: 'git.md',
  GitDiscoverResult: 'git.md',
  GitFileChange: 'git.md',
  GitGraph: 'git.md',
  GitGraphCommit: 'git.md',
  GitGraphRequest: 'git.md',
  GitLogRequest: 'git.md',
  GitProvider: 'git.md',
  GitRepository: 'git.md',
  GitStageRequest: 'git.md',
  GitStatus: 'git.md',
  GitWorktree: 'git.md',
  CatalogProviderId: 'repository.md',
  ForgeCapabilities: 'repository.md',
  ForgeId: 'repository.md',
  ForgeProvider: 'repository.md',
  ForgeState: 'repository.md',
  ForgeStatus: 'repository.md',
  RepositoriesChangedListener: 'repository.md',
  Repository: 'repository.md',
  RepositoryAddRequest: 'repository.md',
  RepositoryCatalogProvider: 'repository.md',
  RepositoryChangeEvent: 'repository.md',
  RepositoryFilter: 'repository.md',
  RepositoryForgeRef: 'repository.md',
  RepositoryId: 'repository.md',
  RepositoryRemote: 'repository.md',
  RepositoryScanRequest: 'repository.md',
  RepositoryScanResult: 'repository.md',
