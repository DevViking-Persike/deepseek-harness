...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('docker-unavailable'), message: z.string(), details: z.object({}) }),
  ...
  z.object({ code: z.literal('editor-unavailable'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('editor-denied'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('editor-not-found'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('editor-not-text'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('editor-too-large'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('editor-stale'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('treadmill-unavailable'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('treadmill-denied'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('treadmill-not-found'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('git-unavailable'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('git-denied'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('git-not-found'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('git-conflicted'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('git-nothing-staged'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('git-failed'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('compose-failed'), message: z.string(), details: z.object({}) }),
