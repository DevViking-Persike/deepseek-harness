...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-agent-preset AgentPresetSeat id \'agent-preset\'',
    ],
    replaceRisk: 'none',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-docker DockerView id \'docker\'',
      'client-ui-editor EditorView id \'editor\'',
      'client-ui-repositories RepositoriesView id \'repositories\'',
  ...
  },
  {
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'conversation.view\' (client-ui-editor), so it exists while that entry is mounted',
    occupants: [
      'client-ui-git GitPanel id \'git\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.view.editor.panel\', () => ctx.slots.register(\n      { name: \'conversation.view.editor.panel\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-editor/src/client/contract.ts:53',
  },
  {
    key: 'conversation.view.repositories.section',
    kind: 'list',
    scope: 'session',
    summary: 'One section inside the repositories view (e.g.',
    doc: 'One section inside the repositories view (e.g. Local, GitHub, GitLab),\nselected by the view\'s top navigation tab bar. Entries render by\nascending `order`.\n\nSession scope: a section reads the addressed session through the\nstandard kit.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'conversation.view\' (client-ui-repositories), so it exists while that entry is mounted',
    occupants: [
      'client-ui-repository-github RepositoryGithubSection id \'github\'',
      'client-ui-repository-gitlab RepositoryGitlabSection id \'gitlab\'',
      'client-ui-repository-local RepositoryLocalSection id \'local\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.view.repositories.section\', () => ctx.slots.register(\n      { name: \'conversation.view.repositories.section\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-repositories/src/client/contract.ts:22',
  },
  {
    key: 'details',
    kind: 'single',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-knowledge KnowledgeSection id \'knowledge\'',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      'client-ui-sidebar SidebarSideToggle id \'sidebar-side-toggle\'',
