 ...
 * the CLIProxyAPI protocol: the literal `[DONE]` is yielded so the caller
 * owns final flushing, and EOF before it raises {@link LlmError}.
 *
 * @module dsh-llm-cliproxy/sse
 */

import { EventSourceParserStream } from 'eventsource-parser/stream'
import { LlmError } from '@deepseek-ai/dsh-llm'

/** The terminal payload CLIProxyAPI sends after the last chunk. */
