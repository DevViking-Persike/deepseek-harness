  ...
  const api: ApiProxy = {
    ...
    skills: {
      list: (request) => {
        ...
        return ok(request, {
          skills: [
            { name: 'fixture-demo', description: 'fixture 技能样本', whenToUse: '仅供 UI 目录渲染验收', modelInvocable: true, source: 'user-agents', provider: 'filesystem' },
            { name: 'fixture-user-only', description: 'fixture 仅用户技能样本', modelInvocable: false, source: 'user-agents', provider: 'filesystem' },
          ],
        })
      },
    },
