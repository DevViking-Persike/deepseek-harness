...
export type {
  ...
  DockerApi, DockerComposeBrowse, DockerComposeBrowseEntry, DockerComposeOutcome,
  DockerContainerEntry, DockerEngineStatusView, DockerImageEntry,
  EditorApi, EditorDirEntry, EditorFile, EditorLanguageServer, EditorListing,
