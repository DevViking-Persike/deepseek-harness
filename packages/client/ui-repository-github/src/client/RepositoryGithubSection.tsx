/**
 * GitHub repository section: shows honest status for the unconfigured host provider
...
import css from './RepositoryGithubSection.module.css'

/** Props passed to RepositoryGithubSection. */
export type RepositoryGithubProps =
  PropsRuntime<'conversation.view.repositories.section'>
  & PropsLocale<'repository-github'>

export function RepositoryGithubSection({ t }: RepositoryGithubProps) {
  return (
