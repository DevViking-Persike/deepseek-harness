/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-client-ui-docker`.
 * @module @deepseek-ai/dsh-client-ui-docker/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-client-ui-docker'

/** Cordis companion plugin name. */
export const name = 'client-ui-docker-invariant'
